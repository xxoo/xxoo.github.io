...
const Chart = function () {
	...
	function Chart(ctn) {
		...
		this[gl].shaderSource(vertShader, 'attribute vec4 coordinates;void main(void){gl_Position=coordinates;}');
		this[gl].shaderSource(fragShader, 'precision lowp float;uniform vec4 fgcolor;void main(void){gl_FragColor=fgcolor;}');
